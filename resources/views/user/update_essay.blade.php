                        ...
                        <form action="{{route('save_essay', session('user'))}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea name="essay" class="form-control"  placeholder=" How can the Kaduna state government improve in the provision of job oppourtunities"  cols="30" rows="10" >{{$user->essay}}</textarea>
                                </div>
